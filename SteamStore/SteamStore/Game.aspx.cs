...
namespace SteamStore
{
    ...
    public partial class Game : System.Web.UI.Page
    {
        ...
        {
            //don't do anything when it is a postback
            if (!IsPostBack)
            {
                ...
                using (var con = DbProvider.GetOracleConnection())
                {
                    ...
                    {
                        //select all the corosponding image id's
                    ...
                    {
                        //load all the packs
                        //with packid, packname, packdescription and all games seperated by ', '
                        ...
                        while (r.Read())
                        {
                            //add them in an gameViewPack object
